...
email the Phi project maintainer at [uke_sjtu@sjtu.edu.cn](mailto:uke_sjtu@sjtu.edu.cn).
...
4. **Permanent Ban**
   1. **Event:** A pattern of repeated code of conduct violations that other steps on the ladder
      have failed to resolve, or a violation so serious that the Community Moderators determine
      there is no way to keep the community safe with this person as a member.
...
[Contributor Covenant website](https://www.contributor-covenant.org/translations). Additional
enforcement and community guideline resources can be found in the
[resources guide](https://www.contributor-covenant.org/resources). The enforcement ladder was
